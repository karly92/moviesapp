...
class PeliculasControllerTest < ActionController::TestCase
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post :create, pelicula: { actores: @pelicula.actores, anio: @pelicula.anio, genero: @pelicula.genero, imagen: @pelicula.imagen, titulo: @pelicula.titulo }
    end
  ...
  test "should update pelicula" do
    patch :update, id: @pelicula, pelicula: { actores: @pelicula.actores, anio: @pelicula.anio, genero: @pelicula.genero, imagen: @pelicula.imagen, titulo: @pelicula.titulo }
    assert_redirected_to pelicula_path(assigns(:pelicula))
  end
